 ...
 * @author jimi
 */
public class FormMenuM extends JMPCFormModal {

    /**
     * Creates new form FormMenuM
     */
    public FormMenuM(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormMenuM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormMenuM dialog = new FormMenuM(new javax.swing.JFrame(), true);
