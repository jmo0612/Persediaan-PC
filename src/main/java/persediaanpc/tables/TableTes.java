...
public class TableTes {
    ...
    public static TableTes create(String query,boolean isLookup){
        return new TableTes(query,isLookup);
    }
    
    public static TableTes create(String query){
        return new TableTes(query,false);
    }
    public static TableTes create(boolean isLookup){
        return new TableTes(null,isLookup);
    }
    public static TableTes create(){
        return new TableTes(null,false);
    }
    
    public TableTes(String query,boolean isLookup){
